...
GROUP BY p.last_name, p.first_name, i.ida, cpt.short_desc, c.inst_abrv, t.diag_type, t.diag_code, t.description, m.category, f2.last_name
ORDER BY p.last_name, p.first_name, i.ida, cpt.short_desc, c.inst_abrv, t.diag_type, t.diag_code, t.description, m.category, f2.last_name, fractions;
